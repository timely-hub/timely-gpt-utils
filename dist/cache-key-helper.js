...
class CacheKeyHelper {
     ...
     */
    static getCategoryPattern(server, category) {
     ...
     */
    static getAllCategories(server) {
     ...
     */
    static getCategoryKeyTypes(server, category) {
        const categoryObj = this.keys[server][category];
        if (!categoryObj) {
